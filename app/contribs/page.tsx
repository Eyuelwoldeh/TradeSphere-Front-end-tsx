        ...
        <div className="bg-white rounded-lg p-8 mb-8 border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <span className="text-gray-600">Pilot Users</span>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              ...
              <span className="text-gray-900 font-semibold">50% faster</span>
            </div>
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <span className="text-gray-600">Phase</span>
              <span className="text-gray-900 font-semibold">MVP Testing</span>
            </div>
          </div>
        </div>
